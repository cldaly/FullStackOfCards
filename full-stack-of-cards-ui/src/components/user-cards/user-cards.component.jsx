...
class UserCards extends React.Component
{
    ...
    getCards = () => {
        ...
        Axios.get('https://full-stack-cards-backend.herokuapp.com/api/flashcards/getUserCards', {params: {userId : localStorage.getItem('user-id')}})
        .then(data => {            
    ...
    deleteCard = (id) => {
        Axios.delete('https://full-stack-cards-backend.herokuapp.com/api/flashcards/removeCard/'+ id).then(data => this.getCards());
